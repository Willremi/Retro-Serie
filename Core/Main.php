...
class Main
{
    public function start()
    {
        ...
        // http://mes-annonces.local/controleur/methode/parametres
        // http://mes-annonces.local/annonces/details/toto
        // http://mes-annonces.local/index.php?p=annonces/details/toto

        // On retire le "trailing slash" éventuel de l'URL
        // On récuppère l'adresse
        ...
        if ($params[0] != "") {
            // On sauvegarde le 1er paramètre dans $controller en mettant sa 1ère lettre en majuscule, en ajoutant le namespace des contrôleurs et en ajoutant "Controller" à la fin
